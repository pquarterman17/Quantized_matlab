# Boson — Detailed Feature Reference
...
Launched from Boson → Tools → **Figures...** button. Opens a popup with figure types:
...
- **Plot on Main** — overlay fit curve on Boson axes with equation annotation
...
4. **Export** — save as CSV or load directly into Boson as a new dataset (auto-sorted by X)
