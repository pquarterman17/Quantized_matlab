...
%
%   params = bosonPlotter.correctionParams(ds, uiValues)
%
%   Constructs the params struct expected by bosonPlotter.applyCorrections
...
%
%   Output:
%       params      Struct suitable for bosonPlotter.applyCorrections
%
%   See also: bosonPlotter.applyCorrections
