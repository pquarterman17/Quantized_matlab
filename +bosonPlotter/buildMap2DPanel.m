...
%       w.btnDecomposeRSM   uibutton   (open RSM peak-decomposition dialog)
...
map2DGL = uigridlayout(map2DPanel,[20 2], ...
    'RowHeight',    {20, 20, 20, 20, 20, 20, 20, 22, 22, 16, 20, 20, 22, 22, 18, 20, 22, 22, 22, '1x'}, ...
    'ColumnWidth',  {85, '1x'}, ...
    'Padding',      [4 4 4 4], ...
    'RowSpacing',   3, ...
    'ColumnSpacing', 4);
...
% ── Row 18: Decompose RSM ────────────────────────────────────────
btnDecomposeRSM = uibutton(map2DGL,'Text','Decompose RSM...', ...
    'BackgroundColor', [0.40 0.30 0.60], ...
    'FontColor', [1 1 1], ...
    'Tooltip', ['Find substrate / film peaks and compute ε∥, ε⊥, relaxation.' newline ...
                'Fits each peak with the chosen 2D model; overlays markers on the map.']);
btnDecomposeRSM.Layout.Row = 18; btnDecomposeRSM.Layout.Column = [1 2];

% ── Row 19: Clear 2D matrix ──────────────────────────────────────
...
btnClear2DMatrix.Layout.Row = 19; btnClear2DMatrix.Layout.Column = [1 2];
...
w.btnDecomposeRSM   = btnDecomposeRSM;
