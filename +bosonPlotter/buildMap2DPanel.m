...
efBoxIntW = uieditfield(map2DGL,'Value','','Placeholder','number or "all"', ...
    'FontSize',10, ...
    'Tooltip',['Box width in axis units (X-axis extent).' newline ...
               'Enter a number, "all" | ":" | "*" for the full data range,' newline ...
               'or leave blank for free-draw (drag-on-map) mode.']);
...
efBoxIntH = uieditfield(map2DGL,'Value','','Placeholder','number or "all"', ...
    'FontSize',10, ...
