...
%APPLYCORRECTIONS  Apply the BosonPlotter corrections pipeline to a data struct.
%
%   corrData = bosonPlotter.applyCorrections(rawData, params)
%   corrData = bosonPlotter.applyCorrections(rawData, params, 'BgDataset', bgDs)
%
%   This is the core, GUI-independent corrections pipeline extracted from
%   BosonPlotter.  It takes raw data + a params struct and returns corrected
%   data.  BosonPlotter's onApplyCorrections reads UI widgets into `params`,
%   then delegates here.
%
%   Inputs:
...
%
%   See also: BosonPlotter, bosonPlotter.correctionParams
