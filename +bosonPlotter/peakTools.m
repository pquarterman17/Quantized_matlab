classdef peakTools
%PEAKTOOLS  Self-contained peak analysis dialogs extracted from BosonPlotter.
%
...
%       result = peakTools.williamsonHall(ds, wavelength_A, kFactor, instBroadening_deg, options)
    ...
    methods (Static)
        ...
        %
        %   Syntax:
        %       result = bosonPlotter.peakTools.refineLattice(ds, wavelength_A)
        %       result = bosonPlotter.peakTools.refineLattice(ds, wavelength_A, Name, Value)
        %
        %   Inputs:
        ...
        %
        %   Example:
        %       r = bosonPlotter.peakTools.refineLattice(ds, 1.5406);
        ...
        %
        %   Syntax:
        %       bosonPlotter.peakTools.matchPhases(ds, wavelength_A)
        %       bosonPlotter.peakTools.matchPhases(ds, wavelength_A, Name, Value)
        %
        %   Inputs:
        ...
        %       StatusFcn   — function_handle for status messages
        %       MainAx      — main BosonPlotter axes handle for overlay
        %
        %   Example:
        %       bosonPlotter.peakTools.matchPhases(ds, 1.5406, MainAx=ax);
        ...
        %
        %   Syntax:
        %       result = bosonPlotter.peakTools.fftThickness(ds, wavelength_A)
        %       result = bosonPlotter.peakTools.fftThickness(ds, wavelength_A, Name, Value)
        %
        %   Inputs:
        %       ds           — dataset struct
        %       wavelength_A — X-ray wavelength in Ångströms
        ...
        %
        %   Example:
        %       r = bosonPlotter.peakTools.fftThickness(ds, 1.5406, AxisLimits=[10 60]);
        ...
        %       result = bosonPlotter.peakTools.reflectivityFFT(ds, Name, Value)
        %
        %   Inputs:
        ...
        %
        %   Example:
        %       r = bosonPlotter.peakTools.reflectivityFFT(ds, WavelengthA=1.5406);
        ...
        %
        %   Syntax:
        %       result = bosonPlotter.peakTools.williamsonHall(ds, wavelength_A, kFactor, instBroadening_deg)
        %       result = bosonPlotter.peakTools.williamsonHall(..., Name, Value)
        %
        %   Inputs:
        %       ds                  — dataset struct with .peaks
        %       wavelength_A        — X-ray wavelength in Ångströms
        ...
        %
        %   Example:
        %       r = bosonPlotter.peakTools.williamsonHall(ds, 1.5406, 0.9, 0);
