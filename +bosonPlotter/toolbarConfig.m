...
% ── Syntax ────────────────────────────────────────────────────────────────
%
%   config = bosonPlotter.toolbarConfig(currentConfig, availableActions)
%
% ── Inputs ────────────────────────────────────────────────────────────────
%
...
%   cfg = bosonPlotter.toolbarConfig({'grid'}, actions);
%
% ════════════════════════════════════════════════════════════════════════
...
lblTitle = uilabel(rootGL, ...
    'Text',               'Use the arrow buttons to move actions between lists.', ...
    'FontSize',           11, ...
...
lblAvail = uilabel(leftGL, 'Text', 'Available Actions', ...
    'FontSize', 10, 'FontColor', [0.65 0.65 0.65], ...
    'HorizontalAlignment', 'center');
lblAvail.Layout.Row = 1;
...
lblCurrent = uilabel(rightGL, 'Text', 'Current Toolbar', ...
    'FontSize', 10, 'FontColor', [0.65 0.65 0.65], ...
    'HorizontalAlignment', 'center');
lblCurrent.Layout.Row = 1;
...
lblSpacer = uilabel(botGL, 'Text', '');
lblSpacer.Layout.Column = 2;
