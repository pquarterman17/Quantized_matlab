...
| Plan | Focus | Status |
|------|-------|--------|
| [improvements-audit-2026-04-11.md](improvements-audit-2026-04-11.md) | Multi-workstream audit: usability, perf, UI, docs (59 items, 10 completed) | Active |
| [codebase-roadmap.md](codebase-roadmap.md) | Monolith extraction, package README coverage | Active |
| [origin-feature-gap.md](origin-feature-gap.md) | OriginPro parity — MATLAB complete, Python ports remaining | Active |
