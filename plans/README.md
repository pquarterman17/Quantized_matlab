...
organized by domain (DataPlotter, parsers, codebase) and includes only
...
|---------|-----------|----------|
| [dataplotter-roadmap.md](dataplotter-roadmap.md) | Corrections panel restructure, XRR fitting, macro integration, large-data performance | Mixed |
| [parser-roadmap.md](parser-roadmap.md) | New parsers (Oxford, Raman, OPUS, SPC) — blocked on example files | Low |
| [codebase-roadmap.md](codebase-roadmap.md) | Break up DataPlotter.m, documentation refresh | Medium |
...
|------|-----------|-------------|
| originpro-inspired-features.md | 2026-03-21 | 8 phases: curve fitting, templates, stats, batch fit, ROI, multi-panel, QoL |
...
| emviewer-phase1.md | 2026-03 | emViewerGUI Phase 1: 20 features |
| emviewer-phase2.md | 2026-03 | emViewerGUI Phase 2: 20 features |
| emviewer-phase3.md | 2026-03 | emViewerGUI Phase 3: 20 DM-parity features |
| emviewer-phase4.md | 2026-03 | emViewerGUI Phase 4: 20 analysis features |
