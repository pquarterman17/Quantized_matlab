...
## BosonPlotter.m — Improvements & Features
...
- [x] **handle panalytical multidimensional x-ray data** datasets from pixel modern panalytical
    ...
    **DONE (2026-03-14)**: `importXRDML` auto-detects 2D area-detector XRDML files (N Omega frames × M
    ...
    reciprocal-space grids. GUI (`BosonPlotter`) renders heatmap/contour with colorbar, log-I toggle,
...
**Status:** All 3 test suites created and integrated. Programmatic API added to `BosonPlotter.m`.
...
- [x] **#6: Automated GUI test harness** — **COMPLETE**
  ...
  - Files: `test_gui_harness.m` (NEW), `BosonPlotter.m` (API added)
...
- [x] **starting BosonPlotter Issue** — FIXED: `efWavelength` set `AllowEmpty=false` 
