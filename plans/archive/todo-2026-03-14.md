...
## DataPlotter.m — Improvements & Features
...
- [x] **handle panalytical multidimensional x-ray data** datasets from pixel modern panalytical
    ...
    **DONE (2026-03-14)**: `importXRDML` auto-detects 2D area-detector XRDML files (N Omega frames × M
    ...
    reciprocal-space grids. GUI (`DataPlotter`) renders heatmap/contour with colorbar, log-I toggle,
...
**Status:** All 3 test suites created and integrated. Programmatic API added to `DataPlotter.m`.
...
- [x] **#6: Automated GUI test harness** — **COMPLETE**
  ...
  - Files: `test_gui_harness.m` (NEW), `DataPlotter.m` (API added)
...
- [x] **starting DataPlotter Issue** — FIXED: `efWavelength` set `AllowEmpty=false` 
