...
%   xrdConvertGUI, test_gui_harness
    ...
    % Row 3: Advanced Analysis (full width)
    ...
    btnAdvanced.Layout.Row = 3; btnAdvanced.Layout.Column = [1 2];

    % Row 4: Plot Options (full width)
    ...
    %ONADDFILES  Open a multi-select file dialog; load every chosen file.
        ...
        [fnames, fpath] = uigetfile( ...
            {'*.dat;*.csv;*.tsv;*.txt;*.xlsx;*.xls;*.xlsm;*.xlsb;*.ods;*.raw;*.xrdml;*.refl;*.pnr;*.datA;*.datB;*.datC;*.datD;*.data;*.datb;*.datc;*.datd;*.jpg;*.jpeg;*.png;*.bmp;*.gif;*.bcf;*.dm3;*.dm4;*.spm;*.000;*.001', ...
             'Supported data files (*.dat, *.csv, *.xlsx, *.raw, *.xrdml, *.refl, *.pnr, *.datA/B/C/D, *.jpg, *.png, *.bmp, *.gif, *.bcf, *.dm3, *.dm4, *.spm)'; ...
             '*.*','All files (*.*)'}, ...
