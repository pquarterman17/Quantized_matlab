...
%
%   result = dataplotter.multiPanel(datasets)
%   result = dataplotter.multiPanel(datasets, Layout='2x1')
%   result = dataplotter.multiPanel(datasets, Layout='2x2', Template='aps')
%
...
%       r = dataplotter.multiPanel({data1, data2}, Layout='2x1');
%
%       % 2x2 grid for APS journal
%       r = dataplotter.multiPanel({d1,d2,d3,d4}, Layout='2x2', Template='aps');
%
%       % Data + residuals below
%       r = dataplotter.multiPanel({data}, Layout='2x1r', ...
...
switch layoutStr
    ...
    otherwise
        error('dataplotter:multiPanel:badLayout', ...
