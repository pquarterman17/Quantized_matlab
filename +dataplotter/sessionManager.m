...
%   older session files created before this refactor remain loadable.
    ...
    methods (Static)
        ...
        %
        %   gs = dataplotter.sessionManager.collectGuiState(widgets)
        %
        %   Input:
        ...
        %            savedYSel, savedY2Sel, savedLogX, savedLogY, savedBGInterp
            ...
            gs.savedYSel      = dataplotter.sessionManager.ensureCell_(widgets.lbY.Value);
            gs.savedY2Sel     = dataplotter.sessionManager.ensureCell_(widgets.lbY2.Value);
        ...
        %
        %   dataplotter.sessionManager.applyGuiState(gs, widgets)
        %
        %   Inputs:
        ...
        %
        %   dataplotter.sessionManager.applyAxisSelections(gs, widgets)
        %
        ...
        %           .guiState   struct (pass to applyGuiState / applyAxisSelections)
            ...
            if ~isfile(matPath)
                error('DataPlotter:sessionNotFound', ...
            ...
            if ~isfield(S, 'savedDatasets')
                error('DataPlotter:invalidSession', ...
            ...
            defs  = dataplotter.sessionManager.datasetDefaults_();
