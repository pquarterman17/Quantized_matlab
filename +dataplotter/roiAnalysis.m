...
%
%   Syntax:
%       dataplotter.roiAnalysis(datasets, activeIdx, mainAx)
%       dataplotter.roiAnalysis(datasets, activeIdx, mainAx, 'StatusFcn', fcn)
%
...
%       mainAx      — handle to main DataPlotter axes
%
%   Options:
...
if isempty(datasets) || activeIdx < 1 || activeIdx > numel(datasets)
    error('dataplotter:roiAnalysis:noDataset', 'No valid dataset.');
end
