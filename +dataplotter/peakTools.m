classdef peakTools
%PEAKTOOLS  Self-contained peak analysis dialogs extracted from DataPlotter.
%
...
%       result = peakTools.williamsonHall(ds, wavelength_A, kFactor, instBroadening_deg, options)
    ...
    methods (Static)
        ...
        %
        %   Syntax:
        %       result = dataplotter.peakTools.refineLattice(ds, wavelength_A)
        %       result = dataplotter.peakTools.refineLattice(ds, wavelength_A, Name, Value)
        %
        %   Inputs:
        ...
        %
        %   Example:
        %       r = dataplotter.peakTools.refineLattice(ds, 1.5406);
        ...
        %
        %   Syntax:
        %       dataplotter.peakTools.matchPhases(ds, wavelength_A)
        %       dataplotter.peakTools.matchPhases(ds, wavelength_A, Name, Value)
        %
        %   Inputs:
        ...
        %       StatusFcn   — function_handle for status messages
        %       MainAx      — main DataPlotter axes handle for overlay
        %
        %   Example:
        %       dataplotter.peakTools.matchPhases(ds, 1.5406, MainAx=ax);
        ...
        %
        %   Syntax:
        %       result = dataplotter.peakTools.fftThickness(ds, wavelength_A)
        %       result = dataplotter.peakTools.fftThickness(ds, wavelength_A, Name, Value)
        %
        %   Inputs:
        %       ds           — dataset struct
        %       wavelength_A — X-ray wavelength in Ångströms
        ...
        %
        %   Example:
        %       r = dataplotter.peakTools.fftThickness(ds, 1.5406, AxisLimits=[10 60]);
        ...
        %       result = dataplotter.peakTools.reflectivityFFT(ds, Name, Value)
        %
        %   Inputs:
        ...
        %
        %   Example:
        %       r = dataplotter.peakTools.reflectivityFFT(ds, WavelengthA=1.5406);
        ...
        %
        %   Syntax:
        %       result = dataplotter.peakTools.williamsonHall(ds, wavelength_A, kFactor, instBroadening_deg)
        %       result = dataplotter.peakTools.williamsonHall(..., Name, Value)
        %
        %   Inputs:
        %       ds                  — dataset struct with .peaks
        %       wavelength_A        — X-ray wavelength in Ångströms
        ...
        %
        %   Example:
        %       r = dataplotter.peakTools.williamsonHall(ds, 1.5406, 0.9, 0);
