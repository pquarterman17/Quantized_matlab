...
%
%   params = dataplotter.correctionParams(ds, uiValues)
%
%   Constructs the params struct expected by dataplotter.applyCorrections
...
%
%   Output:
%       params      Struct suitable for dataplotter.applyCorrections
%
%   See also: dataplotter.applyCorrections
