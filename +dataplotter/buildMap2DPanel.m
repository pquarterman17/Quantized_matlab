...
%
%   Syntax
%     w = dataplotter.buildMap2DPanel(parentGL, isMac)
%
%   Inputs
%     parentGL - uigridlayout that is the parent (analysisGL in DataPlotter)
...
%
%   Examples
%     w = dataplotter.buildMap2DPanel(analysisGL, ismac);
...
map2DGL = uigridlayout(map2DPanel,[18 2], ...
    'RowHeight',    {20, 20, 20, 20, 20, 20, 20, 22, 22, 16, 20, 20, 22, 22, 18, 20, 22, '1x'}, ...
    'ColumnWidth',  {85, '1x'}, ...
    'Padding',      [4 4 4 4], ...
    'RowSpacing',   3, ...
    'ColumnSpacing', 4);
...
btnClear2DMatrix.Layout.Row = 17; btnClear2DMatrix.Layout.Column = [1 2];
