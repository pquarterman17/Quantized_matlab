...
%
%   Syntax
%     w = dataplotter.buildPeakWindow(appData, constants)
%
%   Inputs
%     appData   - dataplotter.AppState handle object (provides fitCurveColor,
...
%     w = dataplotter.buildPeakWindow(appData, c);
