...
%     dataplotter.graphDigitizer('LoadCallback', @myFcn)
%     dataplotter.graphDigitizer('LoadCallback', @myFcn, 'StatusFcn', @setStatus, ...
...
%     dataplotter.graphDigitizer()
%
%     % Integrated with DataPlotter
%     dataplotter.graphDigitizer('LoadCallback', @myLoadFcn, ...
%         'StatusFcn', @setStatus)
...
% Row 16: Load into DataPlotter (via callback)
