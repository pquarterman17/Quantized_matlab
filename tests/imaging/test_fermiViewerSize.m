...
%   Run via group :  runAllTests(Group="emgui")
    ...
    % ════════════════════════════════════════════════════════════════════
    % Current: 11,241 lines (2026-05-15). Display pipeline extraction
    % (-719 lines): displayImage, clearDisplay, prepareDisplayBuffer,
    % setToolsEnabled, displayStackFrame, loadImagesFromPaths, loadImagesAPI
    % moved to +emViewer/ package functions.
    ...
    % at 335, hard-stop at 340. Current FV is 310 + 10 = 320 (2026-05-15
    % after display pipeline extraction). Ceiling kept at 320 to flag any
    % new nested-fn additions. Doubly-nested count must not grow.
