...
- **Enforcement:**
  ...
  - `tests/imaging/test_fermiViewerSize.m` — `FermiViewer.m <= 13,850 lines` and nested-fn total `<= 332` (doubly-nested `<= 16`). Current baseline: 13,807 lines / 331 nested fns (2026-05-06). Runs via `runAllTests(Group="emgui")`.
