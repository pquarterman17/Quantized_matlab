...
- **Enforcement:**
  ...
  - `tests/imaging/test_fermiViewerSize.m` — `FermiViewer.m <= 14,050 lines` and nested-fn total `<= 332` (doubly-nested `<= 16`). Current baseline: 14,021 lines / 331 nested fns (2026-05-04). Runs via `runAllTests(Group="emgui")`.
