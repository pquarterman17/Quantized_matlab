...
- **Enforcement:**
  ...
  - `tests/imaging/test_fermiViewerSize.m` — `FermiViewer.m <= 13,215 lines` and nested-fn total `<= 328` (doubly-nested `<= 16`). Current baseline: 13,188 lines / 326 nested fns (2026-05-06). Runs via `runAllTests(Group="emgui")`.
