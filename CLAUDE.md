...
- **Enforcement:**
  ...
  - `tests/imaging/test_fermiViewerSize.m` — `FermiViewer.m <= 13,780 lines` and nested-fn total `<= 332` (doubly-nested `<= 16`). Current baseline: 13,735 lines / 331 nested fns (2026-05-06). Runs via `runAllTests(Group="emgui")`.
