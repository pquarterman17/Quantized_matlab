...
- **Enforcement:**
  ...
  - `tests/imaging/test_fermiViewerSize.m` — `FermiViewer.m <= 11,135 lines` and nested-fn total `<= 320` (doubly-nested `<= 10`). Current baseline: ~11,108 lines / 319 nested fns (2026-05-10). Runs via `runAllTests(Group="emgui")`.
