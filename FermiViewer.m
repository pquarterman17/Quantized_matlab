...
%   BosonPlotter, test_em_gui_harness
    ...
    % ════════════════════════════════════════════════════════════════════
    % Toolbar: 13 columns — separators replaced by extra ColumnSpacing
    %   Col 1 (80):  Open...
    ...
    %   Col 8 (35):  Grid
    %   Col 9 (35):  EDS
    %   Col 10 (32): Prefs (gear)
    %   Col 11 (32): Theme toggle
    %   Col 12 (28): Shortcuts (?)
    %   Col 13 (1x): Filename label
    ...
    btnZoomOut = uibutton(toolbarGL, 'Text', '', ...
        'Icon', fullfile(fileparts(mfilename('fullpath')), 'icons', 'fermiviewer', 'zoomOut.png'), ...
    ...
    btnShortcuts = uibutton(toolbarGL, 'Text', '?', ...
        'ButtonPushedFcn', @(~,~) onShowEMShortcuts(), ...
        'BackgroundColor', BTN_TOOL, ...
        'FontColor', BTN_FG, ...
        'FontWeight', 'bold', ...
        'Tooltip', 'Keyboard shortcuts');
    btnShortcuts.Layout.Row = 1; btnShortcuts.Layout.Column = 12; %#ok<NASGU>
    ...
    btnExportProfile = uibutton(measureInnerGL, 'Text', 'Export CSV', ...
        'ButtonPushedFcn', @(~,~) onExportAction('exportProfile'), ...
    ...
    % Polyline moved into the ROI-shape dropdown on row 15. Row 6 is now
    % a 2-px spacer (RowHeight above) so Distance + Angle share row 5.
    ...
    btnExportMeasure = uibutton(measureInnerGL, 'Text', 'Export Table', ...
        'ButtonPushedFcn', @(~,~) onExportAction('exportMeasurements'), ...
        'BackgroundColor', BTN_EXPORT, ...
        'FontColor',       BTN_FG, ...
        'Enable',          'off', ...
    ...
    btnZoomDims = uibutton(transformGL, 'Text', 'Fixed Size Zoom', ...
    ...
    annotInnerGL = uigridlayout(pnlAnnot, [7 2], ...
    ...
    btnUndoAnnot.Layout.Row = 7; btnUndoAnnot.Layout.Column = [1 2];
    ...
    % Row 4: DPI
    lblDPI = uilabel(exportInnerGL, 'Text', 'DPI:', 'FontSize', 11);
    ...
    btnCalibColorbar = uibutton(exportInnerGL, 'Text', 'Calibrate Colorbar', ...
