...
%APPLYCORRECTIONS  Apply the Boson corrections pipeline to a data struct.
%
%   corrData = boson.applyCorrections(rawData, params)
%   corrData = boson.applyCorrections(rawData, params, 'BgDataset', bgDs)
%
%   This is the core, GUI-independent corrections pipeline extracted from
%   Boson.  It takes raw data + a params struct and returns corrected
%   data.  Boson's onApplyCorrections reads UI widgets into `params`,
%   then delegates here.
%
%   Inputs:
...
%
%   See also: Boson, boson.correctionParams
