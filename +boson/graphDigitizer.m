...
%     boson.graphDigitizer('LoadCallback', @myFcn)
%     boson.graphDigitizer('LoadCallback', @myFcn, 'StatusFcn', @setStatus, ...
...
%     boson.graphDigitizer()
%
%     % Integrated with Boson
%     boson.graphDigitizer('LoadCallback', @myLoadFcn, ...
%         'StatusFcn', @setStatus)
...
% Row 16: Load into Boson (via callback)
