...
%SESSIONMANAGER  Save and load Boson session .mat files.
%
...
%   older session files created before this refactor remain loadable.
    ...
    methods (Static)
        ...
        %
        %   gs = boson.sessionManager.collectGuiState(widgets)
        %
        %   Input:
        ...
        %            savedYSel, savedY2Sel, savedLogX, savedLogY, savedBGInterp
            ...
            gs.savedYSel      = boson.sessionManager.ensureCell_(widgets.lbY.Value);
            gs.savedY2Sel     = boson.sessionManager.ensureCell_(widgets.lbY2.Value);
        ...
        %
        %   boson.sessionManager.applyGuiState(gs, widgets)
        %
        %   Inputs:
        ...
        %
        %   boson.sessionManager.applyAxisSelections(gs, widgets)
        %
        ...
        %       appData  — boson.AppState handle (datasets read from here)
        ...
        %           .guiState   struct (pass to applyGuiState / applyAxisSelections)
            ...
            defs  = boson.sessionManager.datasetDefaults_();
