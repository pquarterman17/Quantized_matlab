...
%   boson.figureBuilder(datasets, activeIdx)
%
%   Extracted from Boson.m — creates a standalone uifigure for
...
BTN_EXPORT   = [0.18 0.32 0.52];   % slate-blue — export/save actions
        ...
        % ════════════════════════════════════════════════════════════════
        %  Stand-alone helpers (copied from Boson local-function scope)
        % ════════════════════════════════════════════════════════════════
