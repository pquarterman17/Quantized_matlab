...
%
%   Syntax:
%       boson.roiAnalysis(datasets, activeIdx, mainAx)
%       boson.roiAnalysis(datasets, activeIdx, mainAx, 'StatusFcn', fcn)
%
...
%       mainAx      — handle to main Boson axes
%
%   Options:
...
if isempty(datasets) || activeIdx < 1 || activeIdx > numel(datasets)
    error('boson:roiAnalysis:noDataset', 'No valid dataset.');
end
