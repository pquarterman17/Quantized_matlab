...
%
%   result = boson.multiPanel(datasets)
%   result = boson.multiPanel(datasets, Layout='2x1')
%   result = boson.multiPanel(datasets, Layout='2x2', Template='aps')
%
...
%       r = boson.multiPanel({data1, data2}, Layout='2x1');
%
%       % 2x2 grid for APS journal
%       r = boson.multiPanel({d1,d2,d3,d4}, Layout='2x2', Template='aps');
%
%       % Data + residuals below
%       r = boson.multiPanel({data}, Layout='2x1r', ...
...
switch layoutStr
    ...
    otherwise
        error('boson:multiPanel:badLayout', ...
