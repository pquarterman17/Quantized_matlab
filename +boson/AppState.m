...
%APPSTATE  Shared GUI state for Boson (handle class).
%
%   state = boson.AppState()
%
%   Replaces the appData struct with a handle class.  Because handle
%   objects are passed by reference, extracted +boson/ functions
...
%   Boson.m.  The Boson main function assigns to appData =
%   boson.AppState(), and all existing appData.X references work
%   unchanged.
    ...
    properties
        ...
        % ── Dataset groups ────────────────────────────────────────
        datasetGroups             = []   % containers.Map (initialized in Boson)
        ...
        % ── Undo/redo manager ─────────────────────────────────────
        undoMgr                      = []   % boson.UndoManager instance
    ...
    methods
        function obj = AppState()
            ...
            %   The macroLog is created lazily by Boson after construction
