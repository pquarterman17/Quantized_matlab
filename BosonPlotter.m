...
%   xrdConvertGUI, test_gui_harness
    ...
    lblSecOffsets = uibutton(corrGL, 'Text', [char(9660) ' Offsets & BG'], ...
        'FontSize', tk.font.body, 'FontWeight', 'bold', 'FontColor', tk.color.textDim, ...
    ...
    btnAxMore = uibutton(axLimGL, 'Text', [char(9654) ' Appearance'], ...
        'FontSize', tk.font.body, 'FontWeight', 'bold', 'FontColor', tk.color.textMuted, ...
        'BackgroundColor', tk.color.bgPanel, ...
        'HorizontalAlignment', 'left', ...
    ...
    btnSaveHdrData = uibutton(saveGL,'Text',[char(9660) ' Data Export'], ...
        ...
        'BackgroundColor', tk.color.bgPanel,'FontColor', tk.color.textHighlight, ...
