...
%   xrdConvertGUI, test_gui_harness
    ...
    menuCb = struct( ...
        ...
        'onFigureProperties',@(~,~)figDocDispatch_('properties'), 'onQuickExport',@(~,~)figDocDispatch_('export'), 'onCopyForSlides',@(~,~)figDocDispatch_('copy'), 'onAnnotations',@(~,~)figDocDispatch_('annotations'), 'onTraceStyles',@(~,~)figDocDispatch_('traceStyles'), 'onFigDocTemplates',@(~,~)figDocDispatch_('templates'), 'onApplyStyleToAll',@(~,~)figDocDispatch_('applyStyleToAll'), 'onUndoStyle',@(~,~)figDocDispatch_('undo'), 'onExportPreview',@(~,~)figDocDispatch_('preview'), ...
