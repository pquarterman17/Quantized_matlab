...
%   xrdConvertGUI, test_gui_harness
    ...
    lblStatusBar = uilabel(statusGL, 'Text', 'Ready', ...
        'FontSize', tk.font.label, 'FontColor', [0.85 0.85 0.85], ...
    ...
    btnMacroExport = uibutton(statusGL, 'Text', 'Save Script', ...
        'FontSize', tk.font.caption, 'FontColor', [0.5 0.5 0.5], ...
    ...
    lblSecOffsets = uibutton(corrGL, 'Text', [char(9660) ' Offsets & BG'], ...
        'FontSize', tk.font.body, 'FontWeight', 'bold', 'FontColor', [0.55 0.55 0.55], ...
    ...
    btnApplyAll = uibutton(corrGL,'Text','Apply to All', ...
        ...
        'FontColor',[0.75 0.75 0.75],'FontSize', tk.font.body);
    ...
    lblTableStats = uilabel(tableBarGL, 'Text', '', ...
        'FontSize', tk.font.caption, 'FontColor', [0.55 0.55 0.55], ...
        'HorizontalAlignment', 'right');
    ...
    lblFilter = uilabel(filterBarGL, 'Text', 'Filter:', ...
        'FontSize', tk.font.caption, 'FontColor', [0.75 0.75 0.75], ...
        'HorizontalAlignment', 'right');
    ...
    btnAxMore = uibutton(axLimGL, 'Text', [char(9654) ' Appearance'], ...
        'FontSize', tk.font.body, 'FontWeight', 'bold', 'FontColor', [0.75 0.75 0.75], ...
        'BackgroundColor', [0.18 0.18 0.18], ...
        'HorizontalAlignment', 'left', ...
    ...
    btnSaveHdrData = uibutton(saveGL,'Text',[char(9660) ' Data Export'], ...
        'FontSize', tk.font.body,'FontWeight','bold','HorizontalAlignment','left', ...
