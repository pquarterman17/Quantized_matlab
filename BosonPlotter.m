...
%   xrdConvertGUI, test_gui_harness
    ...
    menuCb = struct( ...
        ...
        'onFigureProperties',@onFigureProperties, 'onQuickExport',@onQuickExport, 'onCopyForSlides',@onCopyForSlides, 'onAnnotations',@onAnnotations, 'onTraceStyles',@onTraceStyles, 'onFigDocTemplates',@onFigDocTemplates, 'onApplyStyleToAll',@onApplyStyleToAll, 'onUndoStyle',@onUndoStyle, ...
...
function onSendToOrigin(~,~)
    ...
    function onUndoStyle(~,~),       figDocDispatch_('undo');            end
