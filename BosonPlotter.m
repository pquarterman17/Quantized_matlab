...
%   xrdConvertGUI, test_gui_harness
    ...
    %   Called by onPlot (GUI uiaxes) and onExportFigure (regular axes).
        try
            ...
            % Extracted to +bosonPlotter/drawOverlays.m for maintainability.
...
%{
        ...
        %ONCFPLOTONMAIN  Overlay the fit curve on the main BosonPlotter axes.
        ...
        %CFPICKXRANGE  Click on BosonPlotter axes to set X min or max.
            cfFig.Visible = 'off';
            fig.Pointer = 'crosshair';
