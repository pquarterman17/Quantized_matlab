...
% ── Footer ────────────────────────────────────────────────────────────
lines{end+1} = '<footer><p>Generated by thin_film_toolkit_matlab — scripts.generateReport</p></footer>';
...
% Footer
lines{end+1} = SEP;
lines{end+1} = 'Generated by thin_film_toolkit_matlab — scripts.generateReport';
lines{end+1} = SEP;
