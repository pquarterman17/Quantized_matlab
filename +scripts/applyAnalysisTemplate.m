...
%APPLYANALYSISTEMPLATE  Batch-apply a saved DataPlotter template to multiple files.
%
...
%
%   Loads a template saved from DataPlotter (Templates > Save Template...) and
...
%
%   INPUTS:
%       templatePath — path to a .mat template file saved from DataPlotter
...
%
%   See also scripts.batchImport, scripts.batchConvertXRD, DataPlotter
